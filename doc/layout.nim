...
proc layout*(title: string,
    ...
    html(lang="en"):
        ...
        body:
            ...
            footer:
                p:
                    "This documentation has been generated with emerald."; br()
                    """It has intentionally been designed without gradients and
                    lense flares. If you want gradients and lense flares, go
                    watch a J. J. Abrahms movie."""
